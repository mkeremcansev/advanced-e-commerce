                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header border-bottom">
                                ...
                                <a href="{{ route('Panel.service.add') }}"
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                        <a class="dropdown-item text-success" href="{{ route('Panel.Service.update.get', $service->id) }}">@lang('words.edit')</a>
                                                        <a class="dropdown-item text-danger" href="{{ route('Panel.Service.delete', $service->id) }}">@lang('words.delete')</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
