                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('Panel.Information.add') }}" class="invoice-repeater" method="POST">
                                    @csrf
                            ...
                            <table id="service_list_table" class="dt-responsive table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('Panel.Information.delete', $information->id) }}" class="btn btn-danger waves-effect waves-float waves-light">@lang('words.delete')</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
