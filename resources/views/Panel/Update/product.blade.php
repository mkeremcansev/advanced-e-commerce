...
<script>
    $(document).ready(function () {
        $('#update').click(function () {
            ...
            $.ajax({
                url: '{{ route("Panel.Product.update", $product->id) }}',
                type: 'post',
                data: formData,
                dataType: 'json',
                contentType: false,
                ...
                success: function (data) {
                    ...
                    setTimeout(function () {
                        var url = "{{ route('Panel.Variant.add.get', ":id") }}";
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('Panel.Variant.add.get', $product->id) }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-6">
                                        ...
                                        <form id="imageDelete"
                                            action="{{ route('Panel.Product.update.image', $product->id) }}" method="POST">
                                            @csrf
