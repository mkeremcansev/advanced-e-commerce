...
$(document).ready(function () {
    $("#update").click(function(e){
        ...
        $.ajax({
            type: 'post',
            url: "{{ route('Panel.Variant.update', $value->id) }}",
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><a href="{{ route('Panel.Variant.add.get',$value->getVariantProduct->id) }}"><i data-feather="arrow-left"></i> @lang('words.option-back')</a></h4>
                            </div>
                            <div class="card-body">
