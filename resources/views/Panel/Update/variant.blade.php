                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('Panel.Information.add.get', $product->id) }}" class="btn btn-success waves-effect waves-float waves-light">@lang('words.product-information')</a>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('Panel.Variant.add') }}" class="invoice-repeater" method="POST">
                                    @csrf
                            ...
                            <table id="service_list_table" class="dt-responsive table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('Panel.Variant.update.get', $variantValue->id) }}" class="btn btn-warning waves-effect waves-float waves-light">@lang('words.edit')</a></td>
                                        <td><a href="{{ route('Panel.Variant.delete', $variantValue->id) }}" class="btn btn-danger waves-effect waves-float waves-light">@lang('words.delete')</a></td>
                                    </tr>
                                    @endforeach
