                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">@lang('words.active-review-list')</h4>
                                <a href="{{ route('Panel.Passive.reviews') }}" class="btn btn-info waves-effect waves-float waves-light">@lang('words.passive-review-list')</a>
                            </div>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                        <a class="dropdown-item text-danger" href="{{ route('Panel.Status.review', $review->id) }}">@lang('words.passive')</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
