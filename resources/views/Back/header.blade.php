...
<html id="modeChange" class="loading dark-layout" lang="{{ app()->getLocale() }}" data-textdirection="ltr">
    <head>
        ...
        <link
            ...
            rel="stylesheet"
        />
        <link rel="stylesheet" type="text/css" href="{{ asset('Back/app-assets/css/plugins/extensions/ext-component-tree.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('Back/app-assets/vendors/css/extensions/jstree.min.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('Back/app-assets/fonts/font-awesome/css/font-awesome.min.css') }}">
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/vendors/css/vendors.min.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/vendors/css/extensions/toastr.min.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/css/bootstrap.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/css/bootstrap-extended.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/css/colors.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/css/components.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/css/themes/dark-layout.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/css/themes/bordered-layout.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/css/themes/semi-dark-layout.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/css/core/menu/menu-types/horizontal-menu.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/css/plugins/extensions/ext-component-toastr.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/assets/css/style.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/vendors/css/tables/datatable/dataTables.bootstrap4.min.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/vendors/css/tables/datatable/responsive.bootstrap4.min.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('Back/app-assets/css/pages/page-profile.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
                                ...
                                <li>
                                    <a
                                        class="
                                            ...
                                            align-items-center
                                        "
                                        href="{{ route('Back.announcement.add') }}"
                                        data-toggle="dropdown"
                                    >
                                        <i data-feather="chevrons-right"></i>
                                        <span
                        ...
                        <li class="dropdown nav-item" data-menu="dropdown">
                         ...
                         <li class="dropdown nav-item" data-menu="dropdown">
                            <a
                                ...
                                ><span>@lang('words.opportunity')</span></a
                            >
                            <ul class="dropdown-menu">
                                <li>
                                    <a
                                        class="
                                            ...
                                            align-items-center
                                        "
                                        href="{{ route('Back.opportunity.add') }}"
                                        data-toggle="dropdown"
                                    >
                                        <i data-feather="chevrons-right"></i>
                                        <span>@lang('words.opportunity-add')</span>
                                    </a>
                                    <a
                                        class="
                                            dropdown-item
                                            ...
                                            align-items-center
                                        "
                                        href="{{ route('Back.opportunitys') }}"
                                        data-toggle="dropdown"
                                    >
                                        <i data-feather="chevrons-right"></i>
                                        <span>@lang('words.opportunity-list')</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
