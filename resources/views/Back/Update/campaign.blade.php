                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                    <h4 class="card-title"><a href="{{ route('Campaign.update.get', $campaign->id) }}">{{ $campaign->title }}<i data-feather="arrow-right"></i></a></h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('Campaign.value.add') }}" method="POST">
                                    @csrf
                            ...
                            <table id="service_list_table" class="dt-responsive table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('Campaign.value.delete', $value->id) }}" class="btn btn-danger waves-effect waves-float waves-light">@lang('words.delete')</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
