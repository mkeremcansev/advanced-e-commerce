                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header border-bottom">
                                ...
                                <a href="{{ route('Back.campaign.add') }}"
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                        <a class="dropdown-item text-success" href="{{ route('Campaign.update.get', $campaign->id) }}">@lang('words.edit')</a>
                                                        <a class="dropdown-item text-primary" href="{{ route('Campaign.add.get', $campaign->id) }}">@lang('words.product')</a>
                                                        @if ($campaign->status == 0)
                                                            <a class="dropdown-item text-success" href="{{ route('Campaign.status', ['id'=>$campaign->id, 'status'=>1]) }}">@lang('words.active')</a>
                                                        @else
                                                            <a class="dropdown-item text-warning" href="{{ route('Campaign.status', ['id'=>$campaign->id, 'status'=>0]) }}">@lang('words.passive')</a>
                                                        @endif
                                                        <a class="dropdown-item text-danger" href="{{ route('Campaign.delete', $campaign->id) }}">@lang('words.delete')</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
