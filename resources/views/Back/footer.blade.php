...
<script src="{{ asset('Back/app-assets/vendors/js/ui/jquery.sticky.js') }}"></script>
...
<script src="{{ asset('Back/app-assets/js/scripts/forms/form-select2.js') }}"></script>
<script src="{{ asset('Back/app-assets/js/scripts/extensions/ext-component-toastr.js') }}"></script>
<script src="{{ asset('Back/app-assets/js/scripts/extensions/ext-component-blockui.js') }}"></script>

<script src="{{ asset('Back/app-assets/vendors/js/tables/datatable/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('Back/app-assets/vendors/js/tables/datatable/datatables.bootstrap4.min.js') }}"></script>
<script src="{{ asset('Back/app-assets/vendors/js/tables/datatable/dataTables.responsive.min.js') }}"></script>
<script src="{{ asset('Back/app-assets/vendors/js/tables/datatable/responsive.bootstrap4.js') }}"></script>
<script src="{{ asset('Back/app-assets/js/scripts/tables/table-datatables-advanced.js') }}"></script>
<script src="{{ asset('Back/app-assets/vendors/js/forms/repeater/jquery.repeater.min.js') }}"></script>
<script src="{{ asset('Back/app-assets/js/scripts/forms/form-repeater.js') }}"></script>
<script src="{{ asset('Back/app-assets/js/scripts/pages/page-profile.js') }}"></script>
...
<script src="{{ asset('Back/app-assets/vendors/js/extensions/jstree.min.js') }}"></script>
<script src="{{ asset('Back/app-assets/js/scripts/extensions/ext-component-tree.js') }}"></script>
