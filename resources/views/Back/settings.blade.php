                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            ...
                            <form id="setting_form" method="POST" action="{{ route('Setting.update') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control"
                                            name="keywords">{{ $settings->keywords }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control"
                                            name="adress">{{ $settings->adress }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="map">@lang('words.website-map')</label>
                                        <textarea type="text" class="form-control"
                                            name="map">{{ $settings->map }}</textarea>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-6">
                                        ...
                                        <a href="javascript:void(0)">
                                            <img width="150" src="{{ asset($settings->logo) }}"
                                    ...
                                    <div class="col-md-4 col-6">
                                        ...
                                        <a href="javascript:void(0)">
                                            <img width="20" src="{{ asset($settings->favicon) }}"
                                                class="img-fluid rounded mb-1" />
                                        </a>
                                    </div>
                                </div>
