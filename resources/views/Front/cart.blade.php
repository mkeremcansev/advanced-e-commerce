...
@section('script')
<script>
    // function qtyUp(rowId) {
    //     let quantity = $('.detail-qty #quantity-'+rowId+'').text();
    //     $.ajax({
    //         type: 'POST',
    //         url: url,
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-des product-name">
                                            <h5 class="product-name"><a href="{{ route('Front.product.single', ['category'=>$cart->model->getCategory->slug, 'slug'=>$cart->model->slug]) }}">{{ $cart->name }}</a></h5>
                                        ...
                                        <td class="action"><a href="{{ route('Cart.delete', $cart->rowId) }}" class="text-muted"><i class="fi-rs-trash"></i></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="col-lg-12 col-md-12">
                                <div class="border p-md-4 p-30 cart-totals">
                                    ...
                                    <div class="cart-action text-end">
                                        ...
                                        <a href="{{ route('Cart.destroy') }}" class="btn mr-10 mb-sm-15 col-lg-2 cwCustomBtn"><i class="fi-rs-shuffle mr-10"></i>Update Cart</a>
                                        <a href="{{ route('Cart.destroy') }}" class="btn mr-10 mb-sm-15 col-lg-3 cwFontSize12"><i class="fi-rs-trash mr-10"></i>Temizle</a>
