                ...
                <div class="col-lg-7 mb-md-3 mb-lg-0">
                    <div class="row align-items-center">
                        <div class="col flex-horizontal-center">
                            <img class="icon-email" src="{{ asset('Front') }}/assets/imgs/theme/icons/icon-email.svg"
                                alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        ...
                        <div class="mobile-social-icon wow fadeIn animated mb-sm-5 mb-md-0">
                            <a href="{{ $settings->facebook }}"><img src="{{ asset('Front/assets/imgs/theme/icons/icon-facebook.svg') }}" alt="{{ $settings->facebook }}"></a>
                            <a href="{{ $settings->twitter }}"><img src="{{ asset('Front/assets/imgs/theme/icons/icon-twitter.svg') }}" alt=""></a>
                            <a href="{{ $settings->instagram }}"><img src="{{ asset('Front/assets/imgs/theme/icons/icon-instagram.svg') }}" alt=""></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-8 col-lg-12">
                            ...
                            <div class="download-app wow fadeIn animated">
                                ...
                                <a href="#" class="hover-up"><img
                                        src="{{ asset('Front') }}/assets/imgs/theme/google-play.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-12 mt-md-3 mt-lg-0">
                            <p class="mb-20 wow fadeIn animated">...........</p>
                            <img class="wow fadeIn animated"
                                src="{{ asset('Front') }}/assets/imgs/theme/payment-method.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<script src="{{ asset('Front/assets/js/canseworks.js') }}"></script>
<script src="{{ asset('Front/assets/js/iziToast.min.js') }}"></script>
@yield('script')
</body>
