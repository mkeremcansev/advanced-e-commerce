        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.status == 200){
                    ...
                    setTimeout(function () {
                        window.location.href = '{{ route("Front.account") }}'
                    }, 1500)
...
<div class="page-header breadcrumb-wrap">
    <div class="container canseworksBlack">
        <span></span><a href="{{route('Front.main')}}">Ana Sayfa</a> >
                                            ...
                                            <div class="login_footer form-group">
                                                <div class="chek-form">
                                                    <div class="custome-checkbox">
                                                        ...
                                                        <label class="form-check-label" for="policy"><a href="{{ route('Front.main') }}"><span>@lang('words.register-policy')</span></a></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
