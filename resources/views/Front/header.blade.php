...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('Front/assets/css/iziToast.min.css') }}">
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="{{ route('Front.main') }}"><img src="{{ asset($settings->logo) }}" alt="logo"></a>
                    </div>
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 profile-dropdown-canseworks">
                                        <ul>
                                            @if (Auth::user())
                                                <li>
                                                    <a class="canseworksFontWeight" href="{{ route('Front.account') }}">@lang('words.my-account')</a>
                                                </li>
                                                <li>
                                                    <a class="canseworksFontWeight" href="{{ route('Logout.add') }}">@lang('words.logout')</a>
                                                </li>
                                            @else
                                                <li>
                                                    <a class="canseworksFontWeight" href="{{ route('Front.login-register') }}">@lang('words.login') - @lang('words.register')</a>
                                                </li>
                                            @endif
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative  main-nav">
                                    ...
                                    <li>
                                        <ul class="dropdown-c">
                                            <li>
                                                ...
                                                <ul>
                                                    @include('Front.Category.category', ['children'=>$item->children])
                                                </ul>
                                            </li>
                                        </ul>
                                        @else
                    ...
                    <div class="header-action-right d-block d-lg-none">
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="{{ route('Front.login-register') }}">
                                    <i class="fi-rs-user"></i>
                                </a>
                            </div>
                            <div id="cwCompare" class="header-action-icon-2">
