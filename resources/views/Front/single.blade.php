                ...
                <div class="col-lg-9">
                    <div class="product-detail accordion-detail">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="comment-list">
                                                    <div class="single-comment justify-content-between d-flex">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb text-center">
                                                                <img src="{{ asset('Front') }}/assets/imgs/page/avatar-6.jpg"
                                                                    alt="">
                                                    ...
                                                    <div class="single-comment justify-content-between d-flex">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb text-center">
                                                                <img src="{{ asset('Front') }}/assets/imgs/page/avatar-7.jpg"
                                                                    alt="">
                                                    ...
                                                    <div class="single-comment justify-content-between d-flex">
                                                        <div class="user justify-content-between d-flex">
                                                            <div class="thumb text-center">
                                                                <img src="{{ asset('Front') }}/assets/imgs/page/avatar-8.jpg"
                                                                    alt="">
                                                ...
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html" tabindex="0">
                                                        <img class="default-img"
                                                            src="{{ asset('Front') }}/assets/imgs/shop/product-2-1.jpg"
                                                            alt="">
                                                        <img class="hover-img"
                                                            src="{{ asset('Front') }}/assets/imgs/shop/product-2-2.jpg"
                                                            alt="">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="product-cart-wrap small hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html" tabindex="0">
                                                        <img class="default-img"
                                                            src="{{ asset('Front') }}/assets/imgs/shop/product-3-1.jpg"
                                                            alt="">
                                                        <img class="hover-img"
                                                            src="{{ asset('Front') }}/assets/imgs/shop/product-4-2.jpg"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap small hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html" tabindex="0">
                                                        <img class="default-img"
                                                            src="{{ asset('Front') }}/assets/imgs/shop/product-4-1.jpg"
                                                            alt="">
                                                        <img class="hover-img"
                                                            src="{{ asset('Front') }}/assets/imgs/shop/product-4-2.jpg"
                                                            alt="">
                                        ...
                                        <div class="product-cart-wrap small hover-up mb-0">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html" tabindex="0">
                                                        <img class="default-img"
                                                            src="{{ asset('Front') }}/assets/imgs/shop/product-5-1.jpg"
                                                            alt="">
                                                        <img class="hover-img"
                                                            src="{{ asset('Front') }}/assets/imgs/shop/product-3-2.jpg"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                        ...
                        <div class="banner-img banner-big wow fadeIn f-none animated mt-50">
                            <img class="border-radius-10" src="{{ asset('Front') }}/assets/imgs/banner/banner-4.png"
                                alt="">
