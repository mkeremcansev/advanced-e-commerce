                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-des product-name">
                                            <h5 class="product-name"><a href="{{ route('Front.product.single', $wishlist->model->slug) }}">{{ $wishlist->model->title }}</a></h5>
                                        ...
                                        <td class="action"><a href="{{ route('Wishlist.delete', $wishlist->rowId) }}" class="text-muted"><i class="fi-rs-trash"></i></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
