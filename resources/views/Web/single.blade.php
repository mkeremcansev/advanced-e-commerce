                ...
                <div class="col-lg-9">
                    <div class="product-detail accordion-detail">
                        ...
                        <div class="banner-img banner-big wow fadeIn f-none animated mt-50">
                            <img class="border-radius-10" src="{{ asset('Web') }}/assets/imgs/banner/banner-4.png"
                                alt="">
                ...
                <div class="col-lg-3 primary-sidebar sticky-sidebar">
                    ...
                    <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                        ...
                        <div class="single-post clearfix">
                            <div class="image">
                                <img src="{{ asset('Web') }}/assets/imgs/shop/thumbnail-3.jpg" alt="#">
                            </div>
                        ...
                        <div class="single-post clearfix">
                            <div class="image">
                                <img src="{{ asset('Web') }}/assets/imgs/shop/thumbnail-4.jpg" alt="#">
                            </div>
                            <div class="content pt-10">
                        ...
                        <div class="single-post clearfix">
                            <div class="image">
                                <img src="{{ asset('Web') }}/assets/imgs/shop/thumbnail-5.jpg" alt="#">
                            </div>
                            <div class="content pt-10">
                    ...
                    <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                        <img src="{{ asset('Web') }}/assets/imgs/banner/banner-11.jpg" alt="">
                        <div class="banner-text">
