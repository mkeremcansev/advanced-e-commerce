                                ...
                                <tbody>
                                    ...
                                    <tr class="pr_title">
                                        ...
                                        <td class="product_name">
                                            <h5><a href="{{ route('Web.product.single', $compare->model->slug) }}">{{ $compare->model->title }}</a></h5>
                                        </td>
                                        @endforeach
                                    </tr>
                                    <tr class="pr_price">
                                    ...
                                    <tr class="pr_remove text-muted">
                                        ...
                                        @foreach (Cart::instance('compare')->content() as $compare)
                                        <td class="row_remove">
                                            <a href="{{ route('Web.Compare.delete', $compare->rowId) }}"><i class="fi-rs-trash mr-5"></i></a>
                                        </td>
                                        @endforeach
                                    </tr>
                                </tbody>
